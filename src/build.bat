...
set commons=..\Common\esShader.c ..\Common\esTransform.c ..\Common\esShapes.c ..\Common\esUtil.c  ..\Common\Win32\esUtil_win32.cpp
set libEGL="X:\opengl-es-tests\lib\EGL\libEGL.lib"
set libGLESv2="X:\opengl-es-tests\lib\GLES2\libGLESv2.lib"
set libraries=%libEGL% %libGLESv2%
cl  %includes% /Zi %commons% ..\src\ogles.cpp %libraries% User32.lib Gdi32.lib
popd
